const BOOK_LEGENDS_BLOOKS = [
  { id: "book-harry", name: "Harry Potter", image: "/assets/books/harry-potter.jpg", icon: "BL", rarity: "Common", series: "Harry Potter", motif: "wand" },
  { id: "book-hermione", name: "Hermione Granger", image: "/assets/books/hermione-granger.jpg", icon: "BL", rarity: "Common", series: "Harry Potter", motif: "book" },
  { id: "book-ron", name: "Ron Weasley", image: "/assets/books/ron-weasley.jpg", icon: "BL", rarity: "Common", series: "Harry Potter", motif: "scarf" },
  { id: "book-matilda", name: "Matilda Wormwood", image: "/assets/books/matilda.png", icon: "BL", rarity: "Common", series: "Matilda", motif: "library" },
  ...
  { id: "book-peter", name: "Peter Pan", image: "/assets/books/peter-pan.png", icon: "BL", rarity: "Common", series: "Peter Pan", motif: "feather" },
  ...
  { id: "book-cat-hat", name: "Cat in the Hat", image: "/assets/books/cat-hat.png", icon: "BL", rarity: "Common", series: "Dr. Seuss", motif: "stripe-hat" },
  { id: "book-horton", name: "Horton", image: "/assets/books/horton.png", icon: "BL", rarity: "Common", series: "Dr. Seuss", motif: "clover" },
  { id: "book-dogman", name: "Dog Man", image: "/assets/books/dogman.png", icon: "BL", rarity: "Common", series: "Dog Man", motif: "badge" },
  { id: "book-underpants", name: "Captain Underpants", image: "/assets/books/captain-underpants.png", icon: "BL", rarity: "Common", series: "Captain Underpants", motif: "cape" },
  { id: "book-auggie", name: "Auggie Pullman", image: "/assets/books/auggie.jpg", icon: "BL", rarity: "Common", series: "Wonder", motif: "helmet" },
  { id: "book-ivan", name: "Ivan", image: "/assets/books/ivan.jpg", icon: "BL", rarity: "Common", series: "The One and Only Ivan", motif: "gorilla" },
