...
const IMPLEMENTATION_FILE = path.join(__dirname, "..", "data", "grade8-math-staar-implementation.json");
const NOW = new Date().toISOString();
const GENERATED_BY = "Local Curriculum";
const CATEGORY = "Texas Grade 8 Math";
const LOCAL_PDF = "C:/Users/Casa-Desktop/Downloads/staar-8-math-assessed-curriculum.pdf";
const ASSESSED_CURRICULUM_URL = "https://tea.texas.gov/student-assessment/staar/staar-8-math-assessed-curriculum.pdf";
const BLUEPRINT_URL = "https://tea.texas.gov/student-assessment/staar/staar-8-math-blueprint.pdf";
const GENERATED_IDS = new Set();

const ITEMS = ["tickets", "markers", "books", "stickers", "bags", "boxes", "cups", "pencils"];
const COLORS = ["red", "blue", "green", "yellow", "purple", "orange"];
const PROCESS_CODES = ["8.1A", "8.1B", "8.1C", "8.1D", "8.1E", "8.1F", "8.1G"];
...
function makeQuiz(id, label, teksCode, description, questions) {
  ...
  return {
    ...
    category: CATEGORY,
    tags: ["texas", "teks", "staar", "grade 8", "math", teksCode.toLowerCase().replace(".", "")],
    questions
  };
}
...
function setIdFor(teksCode) {
  return `tx_grade8_math_${teksCode.toLowerCase().replace(".", "_")}`;
}
...
const QUIZ_BUILDERS = [
  ["8.1A", "Math Grade 8 8.1A", "Apply mathematics to problems arising in everyday life, society, and the workplace.", 0, "Mathematical Process Standards", "Core", () => buildProcessApply("8.1A")],
  ["8.1B", "Math Grade 8 8.1B", "Use a problem-solving model that incorporates analyzing information, formulating a plan, determining a solution, justifying the solution, and evaluating the problem-solving process and the reasonableness of the solution.", 0, "Mathematical Process Standards", "Core", () => buildProcessModel("8.1B")],
  ["8.1C", "Math Grade 8 8.1C", "Select tools, including real objects, manipulatives, paper and pencil, and technology as appropriate, and techniques, including mental math, estimation, and number sense as appropriate, to solve problems.", 0, "Mathematical Process Standards", "Core", () => buildProcessTools("8.1C")],
  ["8.1D", "Math Grade 8 8.1D", "Communicate mathematical ideas, reasoning, and their implications using multiple representations, including symbols, diagrams, graphs, and language as appropriate.", 0, "Mathematical Process Standards", "Core", () => buildProcessCommunicate("8.1D")],
  ["8.1E", "Math Grade 8 8.1E", "Create and use representations to organize, record, and communicate mathematical ideas.", 0, "Mathematical Process Standards", "Core", () => buildProcessRepresent("8.1E")],
  ["8.1F", "Math Grade 8 8.1F", "Analyze mathematical relationships to connect and communicate mathematical ideas.", 0, "Mathematical Process Standards", "Core", () => buildProcessRelationships("8.1F")],
  ["8.1G", "Math Grade 8 8.1G", "Display, explain, and justify mathematical ideas and arguments using precise mathematical language in written or oral communication.", 0, "Mathematical Process Standards", "Core", () => buildProcessLanguage("8.1G")],
  ["8.2A", "Math Grade 8 8.2A", cleanDescription("extend previous knowledge of sets and subsets using a visual representation to describe relationships between sets of real numbers"), 1, "Numerical Representations and Relationships", "Supporting", () => buildGrade8RealNumberSets("8.2A")],
  ["8.2B", "Math Grade 8 8.2B", cleanDescription("approximate the value of an irrational number, including pi and square roots of numbers less than 225, and locate that rational number approximation on a number line"), 1, "Numerical Representations and Relationships", "Supporting", () => buildGrade8IrrationalApprox("8.2B")],
  ["8.2C", "Math Grade 8 8.2C", cleanDescription("convert between standard decimal notation and scientific notation"), 1, "Numerical Representations and Relationships", "Readiness", () => buildGrade8ScientificNotation("8.2C")],
  ["8.2D", "Math Grade 8 8.2D", cleanDescription("order a set of real numbers arising from mathematical and real-world contexts"), 1, "Numerical Representations and Relationships", "Supporting", () => buildGrade8OrderRealNumbers("8.2D")],
  ["8.4A", "Math Grade 8 8.4A", cleanDescription("use similar right triangles to develop an understanding that slope, m, given as the rate comparing the change in y-values to the change in x-values, (y2 - y1)/(x2 - x1), is the same for any two points (x1, y1) and (x2, y2) on the same line"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8SlopeRelationships("8.4A")],
  ["8.4B", "Math Grade 8 8.4B", cleanDescription("graph proportional relationships, interpreting the unit rate as the slope of the line that models the relationship"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8SlopeRelationships("8.4B")],
  ["8.4C", "Math Grade 8 8.4C", cleanDescription("use data from a table or graph to determine the rate of change or slope and y-intercept in mathematical and real-world problems"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8SlopeRelationships("8.4C")],
  ["8.5A", "Math Grade 8 8.5A", cleanDescription("represent linear proportional situations with tables, graphs, and equations in the form y = kx"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8LinearFunctions("8.5A")],
  ["8.5B", "Math Grade 8 8.5B", cleanDescription("represent linear non-proportional situations with tables, graphs, and equations in the form y = mx + b, where b not equal to 0"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8LinearFunctions("8.5B")],
  ["8.5E", "Math Grade 8 8.5E", cleanDescription("solve problems involving direct variation"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8LinearFunctions("8.5E")],
  ["8.5F", "Math Grade 8 8.5F", cleanDescription("distinguish between proportional and non-proportional situations using tables, graphs, and equations in the form y = kx or y = mx + b, where b not equal to 0"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8LinearFunctions("8.5F")],
  ["8.5G", "Math Grade 8 8.5G", cleanDescription("identify functions using sets of ordered pairs, tables, mappings, and graphs"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8LinearFunctions("8.5G")],
  ["8.5H", "Math Grade 8 8.5H", cleanDescription("identify examples of proportional and non-proportional functions that arise from mathematical and real-world problems"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8LinearFunctions("8.5H")],
  ["8.5I", "Math Grade 8 8.5I", cleanDescription("write an equation in the form y = mx + b to model a linear relationship between two quantities using verbal, numerical, tabular, and graphical representations"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8LinearFunctions("8.5I")],
  ["8.8A", "Math Grade 8 8.8A", cleanDescription("write one-variable equations or inequalities with variables on both sides that represent problems using rational number coefficients and constants"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8VariablesBothSides("8.8A")],
  ["8.8B", "Math Grade 8 8.8B", cleanDescription("write a corresponding real-world problem when given a one-variable equation or inequality with variables on both sides using rational number coefficients and constants"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8VariablesBothSides("8.8B")],
  ["8.8C", "Math Grade 8 8.8C", cleanDescription("model and solve one-variable equations with variables on both sides of the equal sign that represent mathematical and real-world problems using rational number coefficients and constants"), 2, "Computations and Algebraic Relationships", "Readiness", () => buildGrade8VariablesBothSides("8.8C")],
  ["8.9A", "Math Grade 8 8.9A", cleanDescription("identify and verify the values of x and y that simultaneously satisfy two linear equations in the form y = x + a and y = bx + c"), 2, "Computations and Algebraic Relationships", "Supporting", () => buildGrade8LinearFunctions("8.9A")],
  ["8.3A", "Math Grade 8 8.3A", cleanDescription("generalize that the ratio of corresponding sides of similar shapes are proportional, including a shape and its dilation"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8DilationAndTransformations("8.3A")],
  ["8.3B", "Math Grade 8 8.3B", cleanDescription("compare the attributes of a shape and its dilation(s) on a coordinate plane"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8DilationAndTransformations("8.3B")],
  ["8.3C", "Math Grade 8 8.3C", cleanDescription("use an algebraic representation to explain the effect of a given positive rational scale factor applied to the x- and y-coordinates of a figure"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8DilationAndTransformations("8.3C")],
  ["8.6A", "Math Grade 8 8.6A", cleanDescription("describe the volume formula V = Bh of a cylinder in terms of its base area and its height"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8GeometryMeasurement("8.6A")],
  ["8.6C", "Math Grade 8 8.6C", cleanDescription("use models or diagrams and the Pythagorean theorem to determine the distance between two points on a coordinate plane"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8GeometryMeasurement("8.6C")],
  ["8.7A", "Math Grade 8 8.7A", cleanDescription("solve problems involving the volume of cylinders, cones, and spheres"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8GeometryMeasurement("8.7A")],
  ["8.7B", "Math Grade 8 8.7B", cleanDescription("solve problems involving the lateral and total surface area of prisms, pyramids, and cylinders using nets or formulas"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8GeometryMeasurement("8.7B")],
  ["8.7C", "Math Grade 8 8.7C", cleanDescription("use the Pythagorean theorem and its converse to solve problems"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8GeometryMeasurement("8.7C")],
  ["8.7D", "Math Grade 8 8.7D", cleanDescription("determine the distance between two points on a coordinate plane using the Pythagorean theorem"), 3, "Geometry and Measurement", "Readiness", () => buildGrade8GeometryMeasurement("8.7D")],
  ["8.8D", "Math Grade 8 8.8D", cleanDescription("use informal arguments to establish facts about the angle sum and exterior angle of triangles, about the angles created when parallel lines are cut by a transversal, and the angle-angle criterion for similarity of triangles"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8GeometryMeasurement("8.8D")],
  ["8.10A", "Math Grade 8 8.10A", cleanDescription("generalize the properties of orientation and congruence of translations, reflections, rotations, and dilations of two-dimensional shapes on a coordinate plane"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8DilationAndTransformations("8.10A")],
  ["8.10B", "Math Grade 8 8.10B", cleanDescription("differentiate between transformations that preserve congruence and those that do not"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8DilationAndTransformations("8.10B")],
  ["8.10C", "Math Grade 8 8.10C", cleanDescription("explain the effect of translations, reflections over the x- or y-axis, and rotations limited to 90 degrees, 180 degrees, 270 degrees, and 360 degrees as applied to two-dimensional shapes on a coordinate plane using an algebraic representation"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8DilationAndTransformations("8.10C")],
  ["8.10D", "Math Grade 8 8.10D", cleanDescription("model the effect on linear and area measurements of dilated two-dimensional shapes"), 3, "Geometry and Measurement", "Supporting", () => buildGrade8DilationAndTransformations("8.10D")],
  ["8.5C", "Math Grade 8 8.5C", cleanDescription("contrast bivariate sets of data that suggest a linear relationship with bivariate sets of data that do not suggest a linear relationship from a graphical representation"), 4, "Data Analysis and Personal Financial Literacy", "Supporting", () => buildGrade8LinearFunctions("8.5C")],
  ["8.5D", "Math Grade 8 8.5D", cleanDescription("use a trend line that approximates the linear relationship between bivariate sets of data to make predictions"), 4, "Data Analysis and Personal Financial Literacy", "Readiness", () => buildGrade8LinearFunctions("8.5D")],
  ["8.11A", "Math Grade 8 8.11A", cleanDescription("construct a scatterplot and describe the observed data to address questions of association such as linear, non-linear, and no association between bivariate data"), 4, "Data Analysis and Personal Financial Literacy", "Readiness", () => buildGrade8DataAndFinance("8.11A")],
  ["8.11B", "Math Grade 8 8.11B", cleanDescription("determine the mean absolute deviation and use this quantity as a measure of the average distance data are from the mean using real-world data"), 4, "Data Analysis and Personal Financial Literacy", "Readiness", () => buildGrade8DataAndFinance("8.11B")],
  ["8.12A", "Math Grade 8 8.12A", cleanDescription("solve problems comparing the cost of credit, including acquiring a loan and using credit cards"), 4, "Data Analysis and Personal Financial Literacy", "Supporting", () => buildGrade8DataAndFinance("8.12A")],
  ["8.12C", "Math Grade 8 8.12C", cleanDescription("explain how small amounts invested regularly, including money saved for college and retirement, grow over time"), 4, "Data Analysis and Personal Financial Literacy", "Supporting", () => buildGrade8DataAndFinance("8.12C")],
  ["8.12D", "Math Grade 8 8.12D", cleanDescription("calculate and compare simple interest and compound interest earnings"), 4, "Data Analysis and Personal Financial Literacy", "Supporting", () => buildGrade7Interest("8.12D")],
  ["8.12G", "Math Grade 8 8.12G", cleanDescription("estimate the cost of a two-year and four-year college education, including family contribution and money saved"), 4, "Data Analysis and Personal Financial Literacy", "Supporting", () => buildGrade8DataAndFinance("8.12G")]
];
...
function writeImplementationFile(generatedQuizzes) {
  ...
  const payload = {
    title: "Grade 8 Math TEKS Implementation",
    source: {
      localPdf: LOCAL_PDF,
      officialAssessedCurriculum: ASSESSED_CURRICULUM_URL,
      officialBlueprint: BLUEPRINT_URL,
      notes: "Grade 8 Math implementation continues after Grade 7 was fully completed. The local assessed curriculum PDF and the official TEA assessed curriculum and blueprint were used to define the Grade 8 STAAR scope."
    },
    namingConvention: "Math Grade 8 {TEKS}",
    questionTargetPerSet: 50,
    scope: {
      firstTeks: "8.1A",
      assessedFirstTeks: "8.2A",
      assessedLastTeks: "8.12G",
      implementedLastTeks: "8.12G",
...
function main() {
  ...
  console.log(`Wrote ${generatedQuizzes.length} Texas Grade 8 math TEKS sets and ${totalQuestions} questions to ${CUSTOM_QUIZZES_FILE}`);
  console.log(`Wrote Grade 8 implementation file to ${IMPLEMENTATION_FILE}`);
}
