...
const BLOOK_PACKS = [
  ...
  },
  {
    id: "anime",
    name: "Anime Pack",
    description: "Iconic anime heroes plus Dragon Ball powerhouses. All free!",
    price: 0,
    blooks: [
      { id: "anime-naruto", name: "Naruto Uzumaki", image: "/assets/anime/naruto.jpg", icon: "🍜", rarity: "Common", series: "Naruto" },
      { id: "anime-goku", name: "Goku SSJ3", image: "/assets/anime/goku.jpg", icon: "🐉", rarity: "Rare", series: "Dragon Ball Z" },
      ...
      { id: "anime-rimuru", name: "Rimuru Tempest", image: "/assets/anime/rimuru.png", icon: "🌀", rarity: "Common", series: "That Time I Got Reincarnated as a Slime" },
      { id: "anime-yusuke", name: "Trunks", image: "/assets/anime/trunks.jpg", icon: "🗡️", rarity: "Common", series: "Dragon Ball Z" },
      { id: "anime-goku-black", name: "Goku Black", image: "/assets/anime/goku-black.jpg", icon: "🌑", rarity: "Epic", series: "Dragon Ball Super" },
      { id: "anime-hit", name: "Hit", image: "/assets/anime/hit.jpg", icon: "⚡", rarity: "Rare", series: "Dragon Ball Super" },
      { id: "anime-beerus", name: "Beerus", image: "/assets/anime/beerus.jpg", icon: "🔮", rarity: "Epic", series: "Dragon Ball Super" },
      { id: "anime-whis", name: "Whis", image: "/assets/anime/whis.jpg", icon: "✨", rarity: "Legendary", series: "Dragon Ball Super" },
...

  {
    ...
    description: "Movie superheroes from Marvel, Spider-Verse, and DC with real character images.",
    price: 20,
    blooks: [
      ...
      { id: "marvel-iron-man", name: "Iron Man", image: "/assets/superheroes/iron-man.jpg", icon: "M", rarity: "Legendary", universe: "Marvel", role: "Hero" },
      ...
      { id: "marvel-thor", name: "Thor", image: "/assets/superheroes/thor.jpg", icon: "M", rarity: "Legendary", universe: "Marvel", role: "Hero" },
      { id: "marvel-hulk", name: "Hulk", image: "/assets/superheroes/hulk.jpg", icon: "M", rarity: "Legendary", universe: "Marvel", role: "Hero" },
      ...
      { id: "marvel-hawkeye", name: "Hawkeye", image: "/assets/superheroes/hawkeye.jpg", icon: "M", rarity: "Common", universe: "Marvel", role: "Hero" },
      ...
      { id: "marvel-black-panther", name: "Black Panther", image: "/assets/superheroes/black-panther.jpg", icon: "M", rarity: "Epic", universe: "Marvel", role: "Hero" },
      ...
      { id: "marvel-ant-man", name: "Ant-Man", image: "/assets/superheroes/ant-man.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-wasp", name: "The Wasp", image: "/assets/superheroes/wasp.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-winter-soldier", name: "Winter Soldier", image: "/assets/superheroes/winter-soldier.jpg", icon: "M", rarity: "Epic", universe: "Marvel", role: "Hero" },
      { id: "marvel-war-machine", name: "War Machine", image: "/assets/superheroes/war-machine.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-vision", name: "Vision", image: "/assets/superheroes/vision.jpg", icon: "M", rarity: "Epic", universe: "Marvel", role: "Hero" },
      { id: "marvel-shang-chi", name: "Shang-Chi", image: "/assets/superheroes/shang-chi.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-star-lord", name: "Star-Lord", image: "/assets/superheroes/star-lord.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-gamora", name: "Gamora", image: "/assets/superheroes/gamora.jpg", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-groot", name: "Groot", image: "/assets/superheroes/groot.png", icon: "M", rarity: "Common", universe: "Marvel", role: "Hero" },
      { id: "marvel-rocket", name: "Rocket", image: "/assets/superheroes/rocket.png", icon: "M", rarity: "Rare", universe: "Marvel", role: "Hero" },
      { id: "marvel-drax", name: "Drax", image: "/assets/superheroes/drax.jpg", icon: "M", rarity: "Common", universe: "Marvel", role: "Hero" },
      { id: "marvel-deadpool", name: "Deadpool", image: "/assets/superheroes/deadpool.jpg", icon: "M", rarity: "Epic", universe: "Marvel", role: "Hero" },
      { id: "dc-batman", name: "Batman", image: "/assets/superheroes/batman.jpg", icon: "D", rarity: "Legendary", universe: "DC", role: "Hero" },
      { id: "dc-superman", name: "Superman", image: "/assets/superheroes/superman.jpg", icon: "D", rarity: "Legendary", universe: "DC", role: "Hero" },
      { id: "dc-wonder-woman", name: "Wonder Woman", image: "/assets/superheroes/wonder-woman.jpg", icon: "D", rarity: "Legendary", universe: "DC", role: "Hero" },
      { id: "dc-aquaman", name: "Aquaman", image: "/assets/superheroes/aquaman.jpg", icon: "D", rarity: "Epic", universe: "DC", role: "Hero" },
      { id: "dc-flash", name: "The Flash", image: "/assets/superheroes/flash.jpg", icon: "D", rarity: "Epic", universe: "DC", role: "Hero" },
      { id: "dc-shazam", name: "Shazam", image: "/assets/superheroes/shazam.jpg", icon: "D", rarity: "Rare", universe: "DC", role: "Hero" },
      { id: "dc-blue-beetle", name: "Blue Beetle", image: "/assets/superheroes/blue-beetle.jpg", icon: "D", rarity: "Rare", universe: "DC", role: "Hero" },
...

  {
    id: "science",
    name: "Science Pack",
    description: "NASA-powered science blooks with real mission, robotics, and deep-space imagery.",
    blooks: SCIENCE_BLOOKS
  },
  {
    id: "space",
    name: "Space Pack",
    description: "20 space blooks rebuilt with real NASA mission photos and telescope images.",
    blooks: SPACE_BLOOKS
  },
  {
    id: "nature",
    name: "Nature Pack",
    description: "Cool real-animal favorites with wildlife photos, including your dolphin mascot.",
    blooks: [
      { id: "nature-forest-owl", name: "Dolphin", image: "/assets/nature/dolphin.jpg", icon: "🐬", rarity: "Common" },
      { id: "nature-polar-bear", name: "Red Panda", image: "/assets/nature/red-panda.jpg", icon: "🐼", rarity: "Common" },
      { id: "nature-river-otter", name: "Sea Otter", image: "/assets/nature/sea-otter.jpg", icon: "🦦", rarity: "Rare" },
      { id: "nature-thunder-eagle", name: "Bald Eagle", image: "/assets/nature/bald-eagle.jpg", icon: "🦅", rarity: "Rare" },
      { id: "nature-night-panther", name: "Black Panther", image: "/assets/nature/black-panther.jpg", icon: "🐆", rarity: "Epic" },
      { id: "nature-volcano-fox", name: "Arctic Fox", image: "/assets/nature/arctic-fox.jpg", icon: "🦊", rarity: "Epic" },
      { id: "nature-ancient-turtle", name: "Sea Turtle", image: "/assets/nature/sea-turtle.jpg", icon: "🐢", rarity: "Legendary" },
      { id: "nature-crystal-stag", name: "Snow Leopard", image: "/assets/nature/snow-leopard.jpg", icon: "🐆", rarity: "Legendary" }
    ]
  },
  {
    id: "books",
